...
Na het mergen en de automatische Vercel-deployment repareer je de bestaande OneWorld-records eenmalig via GitHub: open **Actions**, selecteer **Repair OneWorld data**, kies **Run workflow** en ververs de Vercel-app nadat de workflow is geslaagd. De workflow voert zelf de migratie en reparatie uit en toont aantallen voor bijgewerkte, ongewijzigde, mislukte en voorkomen dubbele records.

De reparatie koppelt eerst op het externe OneWorld-ID, daarna op de exacte bron-URL en pas daarna op de conservatieve canonieke sleutel. Feedback, eerste vinddatum en bronhistorie blijven daardoor aan dezelfde vacature gekoppeld.
