...
import { REVIEW_ROUTE, funnelLinks, isActivePath, manageLinks } from "@/lib/site-navigation";
...
export function SiteNav() {
  return <nav className="shell site-nav" aria-label="Hoofdnavigatie">
    ...
    <div className="nav-group nav-funnel">
      {funnelLinks.map(({ href, label }) => <NavLink key={href} href={href} label={label} className={href === REVIEW_ROUTE ? "nav-primary" : undefined}/>)}
    </div>
